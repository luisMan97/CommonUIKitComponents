...
final class ModalCloseBottomView: BaseModalBottomView {
    ...
    private lazy var buttonComponent: IntButtonComponent = {
        ...
        let config: ButtonConfig = ButtonConfig(
            ...
            frame: frame,
            size: .square,
            imageColor: DSColor.Icon.primaryA,
            iconImage: RappiStyle.icon.filledClose.withRenderingMode(.alwaysTemplate)
        )
    ...
    override func setupView() {
        ...
        let view: UIView = buttonComponent.buttonView
    ...
    override func setupAppearance() {
        ...
        let buttonView: UIView = buttonComponent.buttonView
        isUserInteractionEnabled = false
        gradientView.alpha = 0.0
        buttonComponent.buttonView.transform = CGAffineTransform(translationX: 0, y: 122.0)
        DSGradient.Surface.accentA(layer: buttonView.layer, direction: .topLeftToBottomRight)
    }
}
